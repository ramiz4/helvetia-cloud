...
import { Organization, Role } from 'shared-ui';
                ...
                <tr key={member.id} className="group hover:bg-white/5 transition-colors">
                  <td className="px-6 py-4">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <div className="text-white font-semibold">{member.user.username}</div>
                  ...
                  <td className="px-6 py-4">
                    <select
                      ...
                      className="bg-transparent text-slate-300 text-sm focus:outline-none cursor-pointer border-b border-white/10 hover:border-indigo-400 pb-0.5 transition-all"
                    >
                      <option value="OWNER">Owner</option>
                      <option value="ADMIN">Admin</option>
                      <option value="MEMBER">Member</option>
