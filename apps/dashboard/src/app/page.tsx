      ...
      <div className="py-8 animate-fade-in max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-16">
          <div className="space-y-2">
            <h1 className="text-5xl font-extrabold tracking-tight mb-2 text-slate-900 dark:text-transparent dark:bg-linear-to-r dark:from-white dark:to-white/60 dark:bg-clip-text">
              Projects
            </h1>
        ...
        <div className="relative mb-12">
          ...
          <input
            ...
            className="w-full h-16 pl-16 pr-8 bg-white dark:bg-slate-900/50 backdrop-blur-xl border border-slate-200 dark:border-white/10 rounded-3xl focus:outline-none focus:ring-2 focus:ring-indigo-500/50 text-slate-900 dark:text-white font-semibold transition-all shadow-sm dark:shadow-2xl placeholder:text-slate-400 dark:placeholder:text-slate-600 border-none"
          />
        </div>
        ...
        {isLoading ? (
          ...
          <div className="bg-white dark:bg-slate-900/40 backdrop-blur-3xl border border-slate-200 dark:border-white/10 rounded-[48px] text-center p-24 flex flex-col items-center gap-10 shadow-sm dark:shadow-2xl relative overflow-hidden group">
            <div className="absolute inset-0 bg-linear-to-b from-indigo-500/5 dark:from-indigo-500/10 to-transparent opacity-50 transition-opacity group-hover:opacity-100" />
            <div className="w-24 h-24 bg-slate-100 dark:bg-slate-800/80 rounded-[32px] flex items-center justify-center relative z-10 ring-1 ring-slate-200 dark:ring-white/10 group-hover:scale-110 transition-transform duration-500 shadow-xl dark:shadow-3xl">
              <FolderPlus
                size={48}
                className="text-slate-400 dark:text-slate-600 group-hover:text-indigo-500 dark:group-hover:text-indigo-400 transition-colors"
              />
            </div>
