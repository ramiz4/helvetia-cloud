    ...
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 flex flex-col items-center justify-center p-4 sm:p-6 lg:p-8 relative overflow-hidden">
      ...
      <div className="w-full max-w-7xl mx-auto grid lg:grid-cols-2 gap-12">
        ...
        <div className="hidden lg:flex flex-col space-y-8 px-4">
          ...
          {/* Footer for desktop */}
          <footer className="pt-8" aria-label="Desktop footer">
        ...
        <div className="w-full max-w-md mx-auto lg:max-w-none lg:mx-0">
            ...
            >
              ...
              <div className="mb-8">
                ...
                <p className="text-slate-600 dark:text-slate-400">
                  Join thousands of developers on Helvetia Cloud
                </p>
              </div>
          ...
          {/* Mobile Footer */}
          <footer
            className="mt-12 flex flex-col items-center gap-4 lg:hidden"
