      ...
      <div className="mb-8">
        <div className="flex items-center gap-4 mb-2">
          ...
          <div>
            ...
            <p className="text-slate-400">Manage your organization members and preferences</p>
          </div>
        </div>
      </div>
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <input
                    ...
                    readOnly
                    className="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-3 text-white focus:outline-none focus:ring-2 focus:ring-indigo-500/50 transition-all opacity-70 cursor-not-allowed"
                  />
                </div>
                <div>
                  <label className="block text-sm font-medium text-slate-400 mb-2">
