...
function LoginContent() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 flex flex-col items-center justify-center p-4 sm:p-6 lg:p-8 relative overflow-hidden">
      ...
      <div className="w-full max-w-7xl mx-auto grid lg:grid-cols-2 gap-12">
        ...
        <div className="hidden lg:flex flex-col space-y-8 px-4">
          ...
          <footer className="pt-8">
            <div className="flex items-center gap-3 text-slate-500 font-bold text-[10px] uppercase tracking-[0.3em]">
              <div className="w-12 h-px bg-slate-300 dark:bg-white/10" aria-hidden="true" />
        ...
        <div className="w-full max-w-md mx-auto lg:max-w-none lg:mx-0">
          ...
          <Link
            href="/"
            className="lg:hidden inline-flex items-center text-slate-500 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white mb-8 transition-colors group"
          ...
          <main>
            <div
              id="login-form"
              className="bg-white dark:bg-slate-900/80 backdrop-blur-xl border border-slate-200 dark:border-white/10 rounded-3xl p-6 sm:p-8 shadow-2xl relative overflow-hidden"
              role="region"
            ...
            >
              ...
              <div className="mb-8">
                ...
                <p className="text-slate-600 dark:text-slate-400">Welcome back to Helvetia Cloud</p>
              </div>
              ...
              {error && (
                ...
                >
                  <div className="flex items-start gap-3">
                    <div className="p-1 bg-red-500/20 rounded-lg text-red-500 mt-0.5">!</div>
                    <div>
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      required
                      className="w-full pl-12 pr-4 py-3.5 rounded-xl border border-slate-200 dark:border-white/10 bg-white dark:bg-slate-950/50 text-slate-900 dark:text-white placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all"
                    />
                  </div>
                </div>
              ...
              <div className="relative my-6">
                ...
                <div className="relative flex justify-center text-sm">
                  <span className="px-4 bg-white dark:bg-slate-900/80 text-slate-500 font-semibold">
                    Or continue with
                  </span>
                </div>
              </div>
              ...
              <div className="space-y-4">
                ...
                <div className="p-4 bg-indigo-50 dark:bg-indigo-500/5 border border-indigo-100 dark:border-indigo-500/10 rounded-2xl flex gap-3 items-start">
                  <div className="p-1 bg-indigo-500/20 rounded-lg text-indigo-400 mt-0.5 shrink-0">
                    <Shield size={14} />
                  </div>
                ...
                <div className="mt-6 p-4 bg-emerald-50 dark:bg-emerald-500/5 border border-emerald-100 dark:border-emerald-500/10 rounded-2xl flex gap-3 items-start">
                  <div className="p-1 bg-emerald-500/20 rounded-lg text-emerald-400 mt-0.5 shrink-0">
          ...
          {/* Mobile Footer */}
          <footer className="mt-12 flex flex-col items-center gap-4 lg:hidden">
            <div className="flex items-center gap-3 text-slate-500 font-bold text-[10px] uppercase tracking-[0.3em]">
